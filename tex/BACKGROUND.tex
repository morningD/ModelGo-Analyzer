...
Therefore, in this work, we propose an ontology describing ML workflows using RDF graphs, making it both extensible and linkable, and then analyze license compliance through an automated reasoning engine.
