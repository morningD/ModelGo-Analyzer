...
\begin{table}[]
    \caption{Settings and Analysis Results from MG Analyzer with Fuzz Form Matching Enabled.}
    \footnotesize
    \begin{tabular}{|ll|}
...
It is worth mentioning that all results were obtained with fuzzy form matching enabled, maximizing the detection of potential risks.
If these fuzz rules were disabled, fewer issues would be reported. 
