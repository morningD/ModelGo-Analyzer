...
Second, to promote standardized model publishing in the future, we propose a new set of model-specific licenses, \textit{MG Licenses}, offering Creative Commons-style (CC-style) licensing options for developers to choose from.
