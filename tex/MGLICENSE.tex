...
\begin{table*}[tp]
    \caption{List of MG Analyzer-Supported Licenses \& Aggrements (including \textcolor{Construct}{MG Licenses V1.0}) with Their Comparisons in Clarity and Freedom. Grouped by OSS, Free-Content (\&Dataset), Model and sorted first by clarity score, then by freedom score.}
    \tiny
    \label{tab:licenses}
...
This may explain why many models are published under these licenses\footnote{~There are 9,730 models on HuggingFace licensed under CC-BY-NC-4.0 (more than Llama 2), and 770 of them have garnered 1k+ downloads, please ref to Appendix~\ref{apdx:count}.}, despite the fact that they were not originally drafted for models.
...
To address this, we collaborated with a law firm to draft a set of model licenses, tentatively referred to as MG Licenses\footnote{~See MG License text at \href{https://anonymous.4open.science/r/MG-Analyzer-www2025/}{this link}.}. 
