...
\begin{table*}[h]
    \caption{List of MG Analyzer-Supported Licenses (or Aggrements) with Their Comparisons in Clarity and Freedom. Grouped by OSS, Free-Content (\&Dataset), Model and Sorted First by Clarity Score, Then by Freedom Score. }
    \tiny
    \label{tab:licenses}
