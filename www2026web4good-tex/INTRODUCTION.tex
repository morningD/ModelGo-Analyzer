...
However, these paradigms may face potential legal risks if the use and redistribution practices violate the governing licenses of the reused components, akin to GPL violation in the field of Open Source Software (OSS)~\cite{mathur2012empirical}.
...
%\footnote{See case 1:17-cv-01527, 1:14-cv-00221.}.
...
\begin{itemize}
    ...
    We also provide an interface to convert user-input workflow descriptions into RDF graphs following this vocabulary. 
